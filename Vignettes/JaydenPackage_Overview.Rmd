...
## theme_jayden() Function

```{r}

# The `theme_jayden()` function creates a custom theme for ggplot2 to apply specific colors, fonts, and grid styles across plots.
...
# Example plot using the theme_jayden()
ggplot(mtcars, aes(x = mpg, y = hp)) +
  geom_point() +
  theme_jayden(base_size = 14, base_family = "Times New Roman")
